...
class PlantPagePresenter {
  ...
  addPlant(plant) {
    const plants = this.model.getPlants();
    plants.push(plant);
    this.model.savePlants(plants);
  ...
  deletePlant(plantId) {
    let plants = this.model.getPlants();
  ...
  displayPlants() {
    this.view.displayPlants(this.model.getPlants());
  }
}
...
export default class PlantPage {
  constructor() {
    ...
    this.presenter = new PlantPagePresenter(this, this.model);
    this.lat = null;
    this.lon = null;
  }
