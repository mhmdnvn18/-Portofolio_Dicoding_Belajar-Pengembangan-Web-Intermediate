  ...
  #setupFormEventListeners() {
    ...
    this.#form.addEventListener('submit', async (event) => {
      ...
      if (this.#currentPhotoFile) {
        ...
        let photoFileName = 'story-photo.bin'; 

        if (fileToAppend.name) {
            photoFileName = fileToAppend.name;
        } else if (fileToAppend.type) {
            const MimeTypes = { 
              'image/jpeg': 'jpg',
              'image/png': 'png',
              'image/gif': 'gif',
        ...
        formData.append('photo', fileToAppend, photoFileName); 
        ...
        console.log('Instance of Blob?', fileToAppend instanceof Blob); 
