...
export default class MapPage {
  ...
  async afterRender() {
    ...
    const baseLayers = {
      ...
      'MapTiler Streets': L.tileLayer(`https://api.maptiler.com/maps/streets-v2/{z}/{x}/{y}.png?key=${process.env.VITE_MAP_SERVICE_API_KEY}`, {
        attribution: '&copy; <a href="https://www.maptiler.com/copyright/">MapTiler</a> contributors'
      }),
      'MapTiler Satellite': L.tileLayer(`https://api.maptiler.com/maps/hybrid/{z}/{x}/{y}.jpg?key=${process.env.VITE_MAP_SERVICE_API_KEY}`, {
        attribution: '&copy; <a href="https://www.maptiler.com/copyright/">MapTiler</a> contributors'
      })
    };
